...
test[['id','id_sub','label']].to_csv("./result/result{}_original.tsv".format(config.modelId), index=False, header=None, sep='\t')
...
test[['id','id_sub','label']].to_csv("./result/result{}_optimizer.tsv".format(config.modelId), index=False, header=None, sep='\t')
